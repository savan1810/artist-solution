      ...
      <div className=''>
        ...
        <div className='flex justify-around gap-4 w-4/5 mb-10  mx-auto text-justify items-center' data-aos="fade-up" data-aos-duration="2000">
          <div className='overflow-visible h-96 w-1/4'>
            ...
            <p className='mt-4 opacity-70'>Artist Solutions&apos;s primary mission is to create a long-term strong relationship with our valuable customers. We have managed it successfully by designing a website with the client&apos;s inputs and our expert team&lsquo;s ideas. Our mission is to serve various industries through advanced technology and help them to achieve success.
