    ...
    return (
        ...
        <>
            <div className='relative my-6 pb-1 w-4/5 mx-auto rounded-3xl  bg-gradient-to-r from-[#FDFCFB] to-[#E2D1C3] ' style={{}}>
                <h1 className='text-left font-semibold py-8 px-44  w-5/6 tracking-wide text-4xl text-[#0A4D68]' style={{ fontFamily: "josefin sans", color: "", lineHeight: "150%" }}>&ldquo;Join Our Community by using our
                    services and grow your business.&ldquo;
                </h1>
